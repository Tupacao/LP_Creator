...
const DadosUsuario: React.FC<DadosUsuarioProps> = ({ open, onClose }) => {
    ...
    const [userData, setUserData] = useState<{ nome: string; email: string; senha: string; id: string } | null>(null);
    ...
    return (
        <Drawer anchor='right' open={open} onClose={onClose}>
            ...
            >
                ...
                >
                    {userData ? userData.nome : 'Carregando...'} {/* Exibe o nome do usuário ou "Carregando..." */}
                </Typography>
