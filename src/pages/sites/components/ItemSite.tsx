            ...
            >
                <Box sx={{
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 3 }}>
                        <Button onClick={handleClose} variant="outlined" color="primary" sx={{ mr: 2 }}>Cancelar</Button>
                        <Button onClick={handleClose} variant="contained" color="error">Excluir</Button>
                    </Box>
                </Box>
            </Modal>
        </Box>
